...
<div class="eventDetails">
  <div class="eventDetails_box">
    ...
    <h2 class="eventDetails_title"> event details</h2>
    <div class="eventDetails_nameBox">
      ...
      <h3 class="eventDetails_nameOutput"><% String name = (String) request.getAttribute("name");
        out.print(name);%></h3>
<%--      <input type="text" class="eventDetails_nameOutput" value="<% String name = (String) request.getAttribute("name");--%>
<%--        out.print(name);%>">--%>
    </div>
...
<%--        <input type="datetime-local" class="eventDetails_StartTimeTextOutput" value="<% String startTime = (String) request.getAttribute("startDate");--%>
<%--          out.print(startTime);%>">--%>
      </div>
    </div>
...
<%--      <input type="datetime-local" class="eventDetails_EndTimeTextOutput" value="<% String endTime = (String) request.getAttribute("endDate");--%>
<%--          out.print(endTime);%>">--%>
    </div>
    <div class="eventDetails_location">
      <h3 class="eventDetails_locationText">location</h3>
      <h3 class="eventDetails_locationOutput"><% String location = (String) request.getAttribute("location");
        out.print(location);%></h3>
<%--      <input type="text" class="eventDetails_locationOutput" value="<% String location = (String) request.getAttribute("location");--%>
<%--        out.print(location);%>">--%>
...
<%--      <input type="text" class="eventDetails_msgTitleOutput" value="<% String msgTitle = (String) request.getAttribute("msgTitle");--%>
<%--        out.print(msgTitle);%>">--%>
    </div>
...
<%--      <input type="textarea" class="eventDetails_msgDescOutput" value="<% String msgDesc = (String) request.getAttribute("msgDesc");--%>
<%--          out.print(msgDesc);%>">--%>
    </div>
...
//           out.print("<input type=\"text\" class=\"eventDetails_singleEmailText\" value=\"");
...
//           out.print("\">");
    ...
    <div class="eventDetails_btns">
      <%@ include file="../elements/btns_eventDetails.jsp" %>
